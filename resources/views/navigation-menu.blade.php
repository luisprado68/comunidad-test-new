...
{{--                    <x-nav-link href="{{ route('actions-teams') }}" :active="request()->routeIs('dashboard')">--}}
                ...
                <div class="relative ms-3">
                    <x-dropdown align="right" width="48">
                        ...
                        @foreach(\App\Models\Platform::all() as $platform)
                            <div class="border-t border-gray-200"></div>
                            <x-dropdown-link href="{{ route('actions-teams-platform',['platform_id' => $platform->id]) }}">
                                {{ $platform->name }}
                            </x-dropdown-link>
                        @endforeach
                    ...
                    <div class="relative ms-3">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link href="{{ route('rankings-points') }}">
                                    {{ __('Top de Puntos') }}
                                </x-dropdown-link>
